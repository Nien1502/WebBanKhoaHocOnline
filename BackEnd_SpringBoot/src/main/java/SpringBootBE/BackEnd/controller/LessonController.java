...
public class LessonController {
    ...
    private String extractVideoFileName(String rawVideoValue) {
        if (rawVideoValue == null || rawVideoValue.isBlank()) {
            return null;
        }

        String normalized = rawVideoValue.trim().replace('\\', '/');
    ...
    private boolean isSupportedVideoExtension(String fileName) {
        ...
        return SUPPORTED_VIDEO_EXTENSIONS.stream().anyMatch(lowerFileName::endsWith);
    }
